# -*- coding: utf-8 -*-
"""
Created on Thu Aug  1 15:58:07 2024
...
#book lbl text
bookText=Label(userpage,text="update the patient",font=('Arial',18,'bold'),fg="#0077b6")
...
#book btn
book_btn=Button(userpage,text='update now',font=('Arial',13,'bold'),width=39,bg='#48cae4',fg='white',command=update_patient)
...
#medicin text lbl
medicinTextlbl=Label(userpage,text='update the medicine',font=('Arial',18,'bold'),fg="#0077b6")
...
def update_med():
    ...
    import Buy_medic
#medicin btn
medicin_btn=Button(userpage,text='update now',font=('Arial',13,'bold'),width=39,bg='#48cae4',fg='white',command=update_med)
